        ...
        ServerLivingEntityEvents.ALLOW_DEATH.register((entity, damageSource, damageAmount) -> {
            if (isMythicBoss(entity)) {
                ...
                if (damageSource.getAttacker() instanceof ServerPlayerEntity player) {
                    ...
                    player.sendMessage(Text.translatable("prominent.mythicmythic").append("" + level + "").append(Text.translatable("prominent.mythicchallenge")).setStyle(Style.EMPTY.withColor(0xc49952)), false);
                }
