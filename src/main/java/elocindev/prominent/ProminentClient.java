...
import elocindev.prominent.registry.client.ModelPredicateRegistry;
...
public class ProminentClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ResourceBuilderAPI.registerBuiltinPack(FabricLoader.getInstance(), ProminentLoader.MODID, "fancy_hotbar", Text.literal("Fancy Hotbar textures for Prominence II"), true, true);
        ...
        if (FabricLoader.getInstance().isModLoaded("legendarytooltips")) {
            ...
            ModelPredicateRegistry.registerEkavar();
        }
    }
}