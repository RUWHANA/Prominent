...
public class MythicSummoner extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        MutableText AFFIXES = TextAPI.Styles.getGradient(Text.translatable("prominent.mythicaffix"), 1, 0x523a7a, 0x513680, 1.0F);

        tooltip.add(ICON.copy().append(Text.translatable("prominent.mythicmythic")).append(Text.literal(intToRoman(getMythicLevel(stack)))).setStyle(getMythicLevelColor(getMythicLevel(stack))));
        ...
        tooltip.add(Text.literal(" • ").setStyle(Style.EMPTY.withColor(Formatting.GRAY)).append(Text.translatable("prominent.mythicfaceless").setStyle(Style.EMPTY.withColor(0x594b99))));
        tooltip.add(Text.translatable("prominent.mythicdesc1").setStyle(Style.EMPTY.withColor(Formatting.DARK_GRAY)));
        tooltip.add(Text.translatable("prominent.mythicdesc2").setStyle(Style.EMPTY.withColor(Formatting.DARK_GRAY)));
    }
