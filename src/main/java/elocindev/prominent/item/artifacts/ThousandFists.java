...
public class ThousandFists extends SwordItem implements Artifact, Soulbound {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        MutableText ARTIFACT = TextAPI.Styles.getGradient(Text.translatable("prominent.itemsoulfire"), 1, getGradient(stack)[0], getGradient(stack)[1], 2.0F);
        ...
        tooltip.add(Text.literal(ICONS.ACTIVE_ABILITY+" ").append(Text.translatable("prominent.toatf_enraging1").setStyle(Style.EMPTY.withColor(14903072))));
        tooltip.add(Text.translatable("prominent.toatf_enraging2").setStyle(TEXT));
        tooltip.add(Text.translatable("prominent.toatf_enraging3").setStyle(TEXT));
        tooltip.add(Text.literal(" "));
        tooltip.add(Text.translatable("prominent.toatf_enraging4").setStyle(TEXT));
    }
