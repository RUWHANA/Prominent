...
public class Thunderwrath extends SwordItem implements Artifact, Soulbound {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        MutableText ARTIFACT = TextAPI.Styles.getGradient(Text.translatable("prominent.itemstorm"), 1, getGradient(itemStack)[0], getGradient(itemStack)[1], 2.0F);
        ...
        tooltip.add(Text.literal(ICONS.PASSIVE_ABILITY+" ").append(Text.translatable("prominent.serkonidheritage1").setStyle(ABILITY)));
        tooltip.add(Text.translatable("prominent.serkonidheritage2").append(damage > 0 ? (int) damage + "§e " : "").append(Text.translatable("prominent.serkonidheritage3").setStyle(TEXT)));
        tooltip.add(Text.translatable("prominent.serkonidheritage4").setStyle(Style.EMPTY.withColor(Formatting.DARK_GRAY)));
        tooltip.add(Text.literal(" "));
   }
