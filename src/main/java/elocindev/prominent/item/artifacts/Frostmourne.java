...
public class Frostmourne extends SwordItem implements Artifact, Soulbound {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        MutableText ARTIFACT = TextAPI.Styles.getGradient(Text.translatable("prominent.itemrunic"), 1, getGradient(null)[0], getGradient(null)[1], 2.0F);
        ...
        tooltip.add(Text.literal(ICONS.PASSIVE_ABILITY+" ").append(Text.translatable("prominent.frostblade1").setStyle(Style.EMPTY.withColor(0x2d6180))));
        tooltip.add(Text.translatable("prominent.frostblade2").setStyle(TEXT));
        tooltip.add(Text.translatable("prominent.frostblade3").setStyle(TEXT));
        tooltip.add(Text.literal(" "));
        tooltip.add(Text.translatable("prominent.frostblade4").setStyle(TEXT));
    }
